...
/*   Updated: 2019/07/22 13:23:16 by alamit           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	This value should not be less than 384 to maintain IEE-754 extended
**	representation accurate.
**	abs(-16384 - 63 - 63) / sizeof(unsigned)
*/
# define BI_MAX_SIZE 384
...
uint32_t		ft_bigint_div(t_bigint *mod, const t_bigint *div,
	uint32_t q_max);
